...
SprayStyleSpotItemEditor {
    ...
    Component {
        ...
        GridLayout {
            ...
            QGCLabel { text: qsTr("Spot Width") }
            QGCLabel { text: _missionItem.corridorWidth.valueString + " " + _missionItem.corridorWidth.units}
            ...
            QGCLabel { text: qsTr("Turn Distance")}
            QGCLabel { text: _missionItem.turnAroundDistance.valueString + " " + _missionItem.turnAroundDistance.units}
