...
Rectangle {
    ...
    property real   _cameraMinTriggerInterval:  _missionItem.spotCalc.minTriggerInterval.rawValue
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                SpotCalcGrid {
                    Layout.fillWidth:               true
                    spotCalc:                     _missionItem.spotCalc
                    vehicleFlightIsFrontal:         true
                    distanceToSurfaceLabel:         qsTr("ALtitude")
                    frontalDistanceLabel:           qsTr("Water Amount")
                    sideDistanceLabel:              qsTr("Path width")
                }
