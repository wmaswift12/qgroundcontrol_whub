...
class SprayCalc : public CameraSpec
{
    Q_OBJECT

public:
    SprayCalc(PlanMasterController* masterController, const QString& settingsGroup, QObject* parent = nullptr);
    ...
    // When we are creating a manual grid we still use SprayCalc to store the manual grid information. It's a bastardization of what
    // SprayCalc is meant for but it greatly simplifies code and persistance of manual grids.
