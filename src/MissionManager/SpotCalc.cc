...
SpotCalc::SpotCalc(PlanMasterController* masterController, const QString& settingsGroup, QObject* parent)
    ...
    , _metaDataMap                  (FactMetaData::createMapFromJsonFile(QStringLiteral(":/json/SpotCalc.FactMetaData.json"), this))
    ...
    , _adjustedFootprintFrontalFact (settingsGroup, _metaDataMap[adjustedFootprintFrontalName])
{
    ...
    connect(&_valueSetIsDistanceFact,       &Fact::valueChanged,                this, &SpotCalc::_setDirty);
    connect(&_distanceToSurfaceFact,        &Fact::valueChanged,                this, &SpotCalc::_setDirty);
    connect(&_imageDensityFact,             &Fact::valueChanged,                this, &SpotCalc::_setDirty);
    connect(&_frontalOverlapFact,           &Fact::valueChanged,                this, &SpotCalc::_setDirty);
    connect(&_sideOverlapFact,              &Fact::valueChanged,                this, &SpotCalc::_setDirty);
    connect(&_adjustedFootprintSideFact,    &Fact::valueChanged,                this, &SpotCalc::_setDirty);
    connect(&_adjustedFootprintFrontalFact, &Fact::valueChanged,                this, &SpotCalc::_setDirty);
    connect(&_cameraNameFact,               &Fact::valueChanged,                this, &SpotCalc::_setDirty);
    connect(this,                           &SpotCalc::distanceModeChanged,   this, &SpotCalc::_setDirty);

    connect(&_cameraNameFact, &Fact::valueChanged, this, &SpotCalc::_cameraNameChanged);
    connect(&_cameraNameFact, &Fact::valueChanged, this, &SpotCalc::isManualCameraChanged);
    connect(&_cameraNameFact, &Fact::valueChanged, this, &SpotCalc::isCustomCameraChanged);

    connect(&_distanceToSurfaceFact,    &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(&_imageDensityFact,         &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(&_frontalOverlapFact,       &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(&_sideOverlapFact,          &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(sensorWidth(),              &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(sensorHeight(),             &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(imageWidth(),               &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(imageHeight(),              &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(focalLength(),              &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
    connect(landscape(),                &Fact::rawValueChanged, this, &SpotCalc::_recalcTriggerDistance);
...
void SpotCalc::_cameraNameChanged(void)
{
    if (_disableRecalc) {
        return;
    }
...
void SpotCalc::_recalcTriggerDistance(void)
{
...
void SpotCalc::save(QJsonObject& json) const
{
...
bool SpotCalc::load(const QJsonObject& originalJson, bool deprecatedFollowTerrain, QString& errorString, bool forPresets)
{
    ...
    if (version != 2) {
        errorString = tr("SpotCalc section version %1 not supported").arg(version);
        return false;
    }
...
QString SpotCalc::canonicalCustomCameraName(void)
{
    // This string should NOT be translated
    return "Custom Camera";
}

QString SpotCalc::canonicalManualCameraName(void)
{
    // This string should NOT be translated
    return "Manual (no camera specs)";
}

QString SpotCalc::xlatCustomCameraName(void)
{
    return tr("Custom Camera");
}

QString SpotCalc::xlatManualCameraName(void)
{
    return tr("Manual (no camera specs)");
}

void SpotCalc::setDistanceMode(QGroundControlQmlGlobal::AltMode altMode)
{
...
void SpotCalc::_setDirty(void)
{
    setDirty(true);
}

void SpotCalc::setCameraBrand(const QString& cameraBrand)
{
...
void SpotCalc::setCameraModel(const QString& cameraModel)
{
...
void SpotCalc::_setBrandModelFromCanonicalName(const QString& cameraName)
{
...
void SpotCalc::_rebuildCameraModelList(void)
{
    _cameraModelList.clear();
...
void SpotCalc::_setCameraNameFromV3TransectLoad(const QString& cameraName)
{
...
QString SpotCalc::_validCanonicalCameraName(const QString& cameraName)
{
