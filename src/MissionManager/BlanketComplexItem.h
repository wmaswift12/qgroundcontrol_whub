...
Q_DECLARE_LOGGING_CATEGORY(BlanketComplexItemLog)

class PlanMasterController;
class MissionItem;

class BlanketComplexItem : public SprayStyleBlanketItem
{
    Q_OBJECT
...
public:
    ...
    BlanketComplexItem(PlanMasterController* masterController, bool flyView, const QString& kmlOrShpFile);
    ...
    // Overrides from SprayStyleBlanketItem
    void    save                (QJsonArray&  planItems) final;
    bool    specifiesCoordinate (void) const final { return true; }
    double  timeBetweenShots    (void) final;

    // Overrides from VisualMissionionItem
    QString             commandDescription  (void) const final { return tr("Blanket"); }
    ...
    static constexpr const char* jsonBlanketComplexItemTypeValue =   "blanket";
    static constexpr const char* jsonV3BlanketComplexItemTypeValue = "blanket";
