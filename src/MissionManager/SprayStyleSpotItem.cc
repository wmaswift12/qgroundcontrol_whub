...
QGC_LOGGING_CATEGORY(SprayStyleSpotItemLog, "SprayStyleSpotItemLog")

SprayStyleSpotItem::SprayStyleSpotItem(PlanMasterController* masterController, bool flyView, QString settingsGroup)
    : ComplexMissionItem                (masterController, flyView)
    , _spotCalc                         (masterController, settingsGroup)
    , _metaDataMap                      (FactMetaData::createMapFromJsonFile(QStringLiteral(":/json/SprayStyleSpot.SettingsGroup.json"), this))
    ...
    , _terrainAdjustMaxDescentRateFact  (settingsGroup, _metaDataMap[terrainAdjustMaxDescentRateName])
{
    ...
    connect(&_terrainPolyPathQueryTimer, &QTimer::timeout, this, &SprayStyleSpotItem::_reallyQueryTransectsPathHeightInfo);

    // The follow is used to compress multiple recalc calls in a row to into a single call.
    connect(this, &SprayStyleSpotItem::_updateFlightPathSegmentsSignal, this, &SprayStyleSpotItem::_updateFlightPathSegmentsDontCallDirectly,   Qt::QueuedConnection);
    qgcApp()->addCompressedSignal(QMetaMethod::fromSignal(&SprayStyleSpotItem::_updateFlightPathSegmentsSignal));

    connect(&_turnAroundDistanceFact,                   &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(&_hoverAndCaptureFact,                      &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(&_refly90DegreesFact,                       &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(&_terrainAdjustMaxClimbRateFact,            &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(&_terrainAdjustMaxDescentRateFact,          &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(&_terrainAdjustToleranceFact,               &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,        this, &SprayStyleSpotItem::_rebuildTransects);
    connect(&_cameraTriggerInTurnAroundFact,            &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(_spotCalc.adjustedFootprintSide(),        &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(_spotCalc.adjustedFootprintFrontal(),     &Fact::valueChanged,                this, &SprayStyleSpotItem::_rebuildTransects);
    connect(_spotCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleSpotItem::_rebuildTransects);
    
    connect(&_spotCalc   ,                               &SpotCalc::distanceModeChanged,   this, &SprayStyleSpotItem::_rebuildTransects);

    connect(&_turnAroundDistanceFact,                   &Fact::valueChanged,            this, &SprayStyleSpotItem::complexDistanceChanged);
    connect(&_hoverAndCaptureFact,                      &Fact::valueChanged,            this, &SprayStyleSpotItem::complexDistanceChanged);
    connect(&_refly90DegreesFact,                       &Fact::valueChanged,            this, &SprayStyleSpotItem::complexDistanceChanged);
    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,    this, &SprayStyleSpotItem::complexDistanceChanged);

    connect(&_turnAroundDistanceFact,                   &Fact::valueChanged,            this, &SprayStyleSpotItem::greatestDistanceToChanged);
    connect(&_hoverAndCaptureFact,                      &Fact::valueChanged,            this, &SprayStyleSpotItem::greatestDistanceToChanged);
    connect(&_refly90DegreesFact,                       &Fact::valueChanged,            this, &SprayStyleSpotItem::greatestDistanceToChanged);
    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,    this, &SprayStyleSpotItem::greatestDistanceToChanged);

    connect(&_turnAroundDistanceFact,                   &Fact::valueChanged,            this, &SprayStyleSpotItem::_setDirty);
    connect(&_cameraTriggerInTurnAroundFact,            &Fact::valueChanged,            this, &SprayStyleSpotItem::_setDirty);
    connect(&_hoverAndCaptureFact,                      &Fact::valueChanged,            this, &SprayStyleSpotItem::_setDirty);
    connect(&_refly90DegreesFact,                       &Fact::valueChanged,            this, &SprayStyleSpotItem::_setDirty);
    connect(&_terrainAdjustMaxClimbRateFact,            &Fact::valueChanged,            this, &SprayStyleSpotItem::_setDirty);
    connect(&_terrainAdjustMaxDescentRateFact,          &Fact::valueChanged,            this, &SprayStyleSpotItem::_setDirty);
    connect(&_terrainAdjustToleranceFact,               &Fact::valueChanged,            this, &SprayStyleSpotItem::_setDirty);
    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,    this, &SprayStyleSpotItem::_setDirty);

    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::dirtyChanged,   this, &SprayStyleSpotItem::_setIfDirty);
    connect(&_spotCalc   ,                               &SpotCalc::dirtyChanged,      this, &SprayStyleSpotItem::_setIfDirty);

    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,    this, &SprayStyleSpotItem::coveredAreaChanged);

    connect(_spotCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleSpotItem::_amslEntryAltChanged);
    connect(_spotCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleSpotItem::_amslExitAltChanged);
    connect(_spotCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleSpotItem::minAMSLAltitudeChanged);
    connect(_spotCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleSpotItem::maxAMSLAltitudeChanged);
    connect(&_spotCalc   ,                               &SpotCalc::distanceModeChanged,   this, &SprayStyleSpotItem::_amslEntryAltChanged);
    connect(&_spotCalc   ,                               &SpotCalc::distanceModeChanged,   this, &SprayStyleSpotItem::_amslExitAltChanged);
    connect(&_spotCalc   ,                               &SpotCalc::distanceModeChanged,   this, &SprayStyleSpotItem::minAMSLAltitudeChanged);
    connect(&_spotCalc   ,                               &SpotCalc::distanceModeChanged,   this, &SprayStyleSpotItem::maxAMSLAltitudeChanged);
    connect(&_spotCalc   ,                               &SpotCalc::distanceModeChanged,   this, &SprayStyleSpotItem::_updateFlightPathSegmentsSignal);
    connect(&_spotCalc   ,                               &SpotCalc::distanceModeChanged,   this, &SprayStyleSpotItem::_distanceModeChanged);
    connect(&_spotCalc   ,                               &SpotCalc::distanceModeChanged,  _missionController, &MissionController::recalcTerrainProfile);

    connect(&_hoverAndCaptureFact,                      &Fact::rawValueChanged,         this, &SprayStyleSpotItem::_handleHoverAndCaptureEnabled);

    connect(this,                                       &SprayStyleSpotItem::visualTransectPointsChanged, this, &SprayStyleSpotItem::complexDistanceChanged);
    connect(this,                                       &SprayStyleSpotItem::visualTransectPointsChanged, this, &SprayStyleSpotItem::greatestDistanceToChanged);
    connect(this,                                       &SprayStyleSpotItem::wizardModeChanged,           this, &SprayStyleSpotItem::readyForSaveStateChanged);


    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::isValidChanged, this, &SprayStyleSpotItem::readyForSaveStateChanged);

    setDirty(false);
}

void SprayStyleSpotItem::_setCameraShots(int cameraShots)
{
...
void SprayStyleSpotItem::setDirty(bool dirty)
{
    if (!dirty) {
        _surveyAreaPolygon.setDirty(false);
        _spotCalc    .setDirty(false);
    }
    if (_dirty != dirty) {
        _dirty = dirty;
...
void SprayStyleSpotItem::_save(QJsonObject& complexObject)
{
    ...
    if (_spotCalc    .distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain) {
    ...
    QJsonObject SpotCalcObject;
    _spotCalc    .save(SpotCalcObject);
    innerObject[_jsonSpotCalcKey] = SpotCalcObject;
    ...
    //innerObject["Param1Waypoints"] = _spotCalc     .param1Waypoints()->rawValue().toDouble();
    
    complexObject[_jsonSprayStyleSpotItemKey] = innerObject;
}

void SprayStyleSpotItem::setSequenceNumber(int sequenceNumber)
{
...
bool SprayStyleSpotItem::_load(const QJsonObject& complexObject, bool forPresets, QString& errorString)
{
    QList<JsonHelper::KeyValidateInfo> keyInfoList = {
        { _jsonSprayStyleSpotItemKey, QJsonValue::Object, true },
    };
    if (!JsonHelper::validateKeys(complexObject, keyInfoList, errorString)) {
        return false;
    }

    // The SprayStyleSpotItem is a sub-object of the main complex item object
    QJsonObject innerObject = complexObject[_jsonSprayStyleSpotItemKey].toObject();
    ...
    if (version == 1) {
        ...
        //  - _jsonTerrainFollowKeyDeprecated replaced by SpotCalc::distanceMode
    ...
    if (version != 2) {
        errorString = tr("SprayStyleSpotItem version %2 not supported").arg(version);
        return false;
    }
    ...
    QList<JsonHelper::KeyValidateInfo> innerKeyInfoList = {
        ...
        { _jsonSpotCalcKey,               QJsonValue::Object, true },
    ...
    if (!forPresets) {
        ...
        qCDebug(SprayStyleSpotItemLog) << "Loading Mission Items all";
    }

    // Load SpotCalc data
    if (!_spotCalc   .load(innerObject[_jsonSpotCalcKey].toObject(), v1FollowTerrain, errorString, forPresets)) {
        return false;
    }

    // Load SprayStyleSpotItem individual values
    ...
    /*if (innerObject.contains("Param1Waypoints")) {
        _spotCalc    .param1Waypoints()->setRawValue(innerObject["Param1Waypoints"].toDouble());
    } else {
        qCDebug(SprayStyleSpotItemLog) << "Param1Waypoints key missing from plan file. Using default.";
        _spotCalc    .param1Waypoints()->setRawValue(0.0); // Or your preferred default
    }*/    
    ...
    if (_spotCalc    .distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain) {
        ...
        if (!forPresets) {
            ...
            qCDebug(SprayStyleSpotItemLog) << "Loading Mission Items, params7 min max ALT";
        }
    }

    if (!forPresets) {
        if (_spotCalc    .distanceMode() == QGroundControlQmlGlobal::AltitudeModeTerrainFrame) {
            ...
            qCDebug(SprayStyleSpotItemLog) << "emit Altitude HEIGHTS";
        } else {
            ...
            qCDebug(SprayStyleSpotItemLog) << "emit Altitude change MIN MAX";
        }
    }
...
double SprayStyleSpotItem::greatestDistanceTo(const QGeoCoordinate &other) const
{
...
void SprayStyleSpotItem::setMissionFlightStatus(MissionController::MissionFlightStatus_t& missionFlightStatus)
{
...
void SprayStyleSpotItem::_setDirty(void)
{
    setDirty(true);
}

void SprayStyleSpotItem::_setIfDirty(bool dirty)
{
    if (dirty) {
        setDirty(true);
    }
...
void SprayStyleSpotItem::_updateCoordinateAltitudes(void)
{
    emit coordinateChanged(coordinate());
    emit exitCoordinateChanged(exitCoordinate());
}

double SprayStyleSpotItem::coveredArea(void) const
{
    return _surveyAreaPolygon.area();
}

bool SprayStyleSpotItem::_hasTurnaround(void) const
{
    return _turnAroundDistance() > 0;
}

double SprayStyleSpotItem::_turnAroundDistance(void) const
{
    return _turnAroundDistanceFact.rawValue().toDouble();
}

bool SprayStyleSpotItem::hoverAndCaptureAllowed(void) const
{
    return _controllerVehicle->multiRotor() || _controllerVehicle->vtol();
}

void SprayStyleSpotItem::_rebuildTransects(void)
{
    if (_ignoreRecalc) {
        return;
    }
    ...
    switch (_spotCalc    .distanceMode()) {
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleSpotItemLog) << "Internal Error: _rebuildTransects - invalid _spotCalc   .distanceMode()" << _spotCalc.distanceMode();
        return;
...
void SprayStyleSpotItem::_segmentTerrainCollisionChanged(bool terrainCollision)
{
...
void SprayStyleSpotItem::_updateFlightPathSegmentsDontCallDirectly(void)
{
    ...
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleSpotItemLog) << "Internal Error: _updateFlightPathSegmentsDontCallDirectly - invalid _spotCalc   .distanceMode()" << _spotCalc.distanceMode();
        return;
    case QGroundControlQmlGlobal::AltitudeModeRelative:
    case QGroundControlQmlGlobal::AltitudeModeAbsolute:
    {
    ...
    case QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain:
    case QGroundControlQmlGlobal::AltitudeModeTerrainFrame:
        if (_spotCalc    .distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain && _loadedMissionItems.count()) {
            ...
            for (const MissionItem* missionItem: _loadedMissionItems) {
                if (missionItem->command() == MAV_CMD_NAV_WAYPOINT || missionItem->command() == MAV_CMD_CONDITION_GATE) {
                    ...
                    qCDebug(SprayStyleSpotItemLog) << "GeoCoordniate include param7 Altitude";
                }
            }
        } else {
            // We are either:
            ...
            if (_rgFlightPathCoordInfo.count()) {
                FlightPathSegment::SegmentType segmentType = _spotCalc   .distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain ? FlightPathSegment::SegmentTypeGeneric : FlightPathSegment::SegmentTypeTerrainFrame;
...
void SprayStyleSpotItem::_queryTransectsPathHeightInfo(void)
{
    _rgPathHeightInfo.clear();
...
void SprayStyleSpotItem::_reallyQueryTransectsPathHeightInfo(void)
{
    qCDebug(SprayStyleSpotItemLog) << "_reallyQueryTransectsPathHeightInfo";
    ...
    if (transectPoints.count() > 1) {
        ...
        connect(_currentTerrainPolyPathQuery, &TerrainPolyPathQuery::terrainDataReceived, this, &SprayStyleSpotItem::_polyPathTerrainData);
        _currentTerrainPolyPathQuery->requestData(transectPoints);
    }
}

void SprayStyleSpotItem::_queryMissionItemCoordHeights(void)
{
    qCDebug(SprayStyleSpotItemLog) << "_queryMissionItemCoordHeights";

    _rgFlyThroughMissionItemCoords.clear();

    if (_currentTerrainAtCoordinateQuery) {
        qCWarning(SprayStyleSpotItemLog) << "Internal error: _queryMissionItemCoordHeights called multiple times";
    ...
    if (_rgFlyThroughMissionItemCoords.count()) {
        ...
        connect(_currentTerrainAtCoordinateQuery, &TerrainAtCoordinateQuery::terrainDataReceived, this, &SprayStyleSpotItem::_missionItemCoordTerrainData);
        _currentTerrainAtCoordinateQuery->requestData(_rgFlyThroughMissionItemCoords);
    }
}

void SprayStyleSpotItem::_polyPathTerrainData(bool success, const QList<TerrainPathQuery::PathHeightInfo_t>& rgPathHeightInfo)
{
    qCDebug(SprayStyleSpotItemLog) << "_polyPathTerrainData" << success;
...
void SprayStyleSpotItem::_missionItemCoordTerrainData(bool success, QList<double> heights)
{
    qCDebug(SprayStyleSpotItemLog) << "_polyPathTerrainData" << success;
...
SprayStyleSpotItem::ReadyForSaveState SprayStyleSpotItem::readyForSaveState(void) const
{
...
void SprayStyleSpotItem::_adjustForAvailableTerrainData(void)
{
    switch (_spotCalc    .distanceMode()) {
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleSpotItemLog) << "Internal Error: _adjustForAvailableTerrainData - invalid _spotCalc  .distanceMode()" << _spotCalc    .distanceMode();
        return;
    case QGroundControlQmlGlobal::AltitudeModeRelative:
    case QGroundControlQmlGlobal::AltitudeModeAbsolute:
    ...
    emit minAMSLAltitudeChanged();
    emit maxAMSLAltitudeChanged();
    qCDebug(SprayStyleSpotItemLog) << "Emits signal Altitude change in TERRAIN";
}
...
double SprayStyleSpotItem::_altitudeBetweenCoords(const QGeoCoordinate& fromCoord, const QGeoCoordinate& toCoord, double percentTowardsTo)
{
...
int SprayStyleSpotItem::_maxPathHeight(const TerrainPathQuery::PathHeightInfo_t& pathHeightInfo, int fromIndex, int toIndex, double& maxHeight)
{
    maxHeight = qQNaN();
...
void SprayStyleSpotItem::_adjustForMaxRates(void)
{
    ...
    if (qIsNaN(flightSpeed) || (maxClimbRate == 0 && maxDescentRate == 0)) {
        if (qIsNaN(flightSpeed)) {
            qWarning() << "SprayStyleSpotItem::_adjustForMaxRates called with flightSpeed = NaN";
        }
        return;
    }
...
void SprayStyleSpotItem::_adjustForTolerance(void)
{
...
void SprayStyleSpotItem::_buildFlightPathCoordInfoFromTransects(void)
{
    _minAMSLAltitude = _maxAMSLAltitude = qQNaN();

    double distanceToSurface = _spotCalc     .distanceToSurface()->rawValue().toDouble();
...
void SprayStyleSpotItem::_buildFlightPathCoordInfoFromPathHeightInfoForCalcAboveTerrain(void)
{
    _minAMSLAltitude = _maxAMSLAltitude = qQNaN();

    if (_rgPathHeightInfo.count() == 0) {
        qCWarning(SprayStyleSpotItemLog) << "SprayStyleSpotItem::_buildFlightPathCoordInfoFromPathHeightInfo terrain height needed but _rgPathHeightInfo.count() == 0";
        return;
    }
...
void SprayStyleSpotItem::_buildFlightPathCoordInfoFromPathHeightInfoForTerrainFrame(void)
{
    _minAMSLAltitude = _maxAMSLAltitude = qQNaN();

    if (_rgPathHeightInfo.count() == 0) {
        qCWarning(SprayStyleSpotItemLog) << "SprayStyleSpotItem::_buildFlightPathCoordInfoFromPathHeightInfoForTerrainFrame terrain height needed but _rgPathHeightInfo.count() == 0";
        return;
    }
...
void SprayStyleSpotItem::_buildFlightPathCoordInfoFromMissionItems(void)
{
    _minAMSLAltitude = _maxAMSLAltitude = qQNaN();

    if (_rgFlyThroughMissionItemCoordsTerrainHeights.count() == 0) {
        qCWarning(SprayStyleSpotItemLog) << "_buildFlightPathCoordInfoFromMissionItems - terrain height needed but _rgFlyThroughMissionItemCoordsTerrainHeights.count() == 0";
        return;
    }
    if (_rgFlyThroughMissionItemCoordsTerrainHeights.count() != _rgFlyThroughMissionItemCoords.count()) {
        qCWarning(SprayStyleSpotItemLog) << "_buildFlightPathCoordInfoFromMissionItems - _rgFlyThroughMissionItemCoordsTerrainHeights.count() != _rgFlyThroughMissionItemCoords.count()";
        return;
    }
    if (_rgFlyThroughMissionItemCoords.count() < 2) {
        qCWarning(SprayStyleSpotItemLog) << "_buildFlightPathCoordInfoFromMissionItems - rgFlyThroughMissionItemCoords.count() < 2";
        return;
    }
...
int SprayStyleSpotItem::lastSequenceNumber(void) const
{
    if (_loadedMissionItems.count()) {
...
void SprayStyleSpotItem::_distanceModeChanged(int distanceMode)
{
...
void SprayStyleSpotItem::_handleHoverAndCaptureEnabled(QVariant enabled)
{
...
void SprayStyleSpotItem::appendMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
    if (_loadedMissionItems.count()) {
...
void SprayStyleSpotItem::_appendWaypoint(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, MAV_FRAME mavFrame, float holdTime, const QGeoCoordinate& coordinate)
{
    qCDebug(SprayStyleSpotItemLog) << "Loading Mission Items and Altitude at WAYPOINTS";
    double altitude = _spotCalc  .distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain ? coordinate.altitude() : _spotCalc .distanceToSurface()->rawValue().toDouble();
...
void SprayStyleSpotItem::_appendSinglePhotoCapture(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum)
{
    MissionItem* item = new MissionItem(seqNum++,
...
//MODIFICATION for DO_SET_RESUME
void SprayStyleSpotItem::_appendResume(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, MAV_FRAME mavFrame, const QGeoCoordinate& coordinate)
{
    double altitude = _spotCalc  .distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain ? coordinate.altitude() : _spotCalc .distanceToSurface()->rawValue().toDouble();
    ...
    MissionItem* item = new MissionItem(seqNum++,
                                        ...
                                        mavFrame,
                                        2.0,   // param1: Hold time in seconds
                                        0.0,            // No acceptance radius specified
                                        0.0,            // Pass through waypoint
                                        1,        // Yaw unchanged
                                        coordinate.latitude(),
...
//MODIFICATION for SPRAY OFF
void SprayStyleSpotItem::_appendSpraySpotOFF(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, float triggerDistance)
{   
    float volume = triggerDistance;
    ...
    MissionItem* item = new MissionItem(seqNum++,
                                        ...
                                        volume,                      // Amount of Water (L)
                                        0,                           // state is '0' as OFF
                                        0, 0, 0,                     // param 4-7 unused
                                        true,                        // autoContinue
                                        false,                       // isCurrentItem
                                        missionItemParent);
    items.append(item);
}
//MODIFICATION for SPRAY ON
void SprayStyleSpotItem::_appendSpraySpotON(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, float triggerDistance)
{   
    float volume = triggerDistance;
...
void SprayStyleSpotItem::_appendSpraySpotUpdatePoint(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, MAV_FRAME mavFrame, const QGeoCoordinate& coordinate, bool useConditionGate, float triggerDistance)
{
    if (useConditionGate) {
        //_appendResume(items, missionItemParent, seqNum, mavFrame, coordinate);
    } else {
        _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0 /* holdTime */, coordinate);
    }
    _appendSpraySpotON(items, missionItemParent, seqNum, triggerDistance);
    _appendResume(items, missionItemParent, seqNum, mavFrame, coordinate);
}

SprayStyleSpotItem::BuildMissionItemsState_t SprayStyleSpotItem::_buildMissionItemsState(void) const
{
...
void SprayStyleSpotItem::_buildAndAppendMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
    int                         seqNum      = _sequenceNumber;
    BuildMissionItemsState_t    buildState  = _buildMissionItemsState();
    MAV_FRAME                   mavFrame;

    qCDebug(SprayStyleSpotItemLog) << "_buildAndAppendMissionItems";
    ...
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleSpotItemLog) << "Internal Error: _buildAndAppendMissionItems incorrect _spotCalc     .distanceMode" << _spotCalc  .distanceMode();
        mavFrame = MAV_FRAME_GLOBAL_RELATIVE_ALT;
        break;
    }
    ...
    for (int coordIndex=0; coordIndex<_rgFlightPathCoordInfo.count(); coordIndex++) {
        ...
        case CoordTypeInteriorTerrainAdded:
            ...
            _appendSpraySpotON(items, missionItemParent, seqNum, triggerDistance());
            _appendResume(items, missionItemParent, seqNum, mavFrame, coordInfo.coord);
            break;
        case CoordTypeTurnaround:
        {
            bool firstEntryTurnaround   = coordIndex == 0;
            bool lastExitTurnaround     = coordIndex == _rgFlightPathCoordInfo.count() - 1;
            if (buildState.addTriggerAtFirstAndLastPoint && (firstEntryTurnaround || lastExitTurnaround)) {
                _appendSpraySpotUpdatePoint(items, missionItemParent, seqNum, mavFrame, coordInfo.coord, buildState.useConditionGate, firstEntryTurnaround ? triggerDistance() : 0);
            } else {
                _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0 /* holdTime */, coordInfo.coord);
            }
        }
        ...
        case CoordTypeSurveyEntry:
            if (triggerCamera()) {
                if (hoverAndCaptureEnabled()) {
                    ...
                    _appendSpraySpotUpdatePoint(items, missionItemParent, seqNum, mavFrame, coordInfo.coord, buildState.useConditionGate, triggerDistance());
                }
            } else {
                _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0 /* holdTime */, coordInfo.coord);
            }
        ...
        case CoordTypeSurveyExit:
            ...
            if (triggerCamera()) {
                if (hoverAndCaptureEnabled()) {
                    ...
                    _appendSpraySpotUpdatePoint(items, missionItemParent, seqNum, mavFrame, coordInfo.coord, buildState.useConditionGate, triggerDistance() /* triggerDistance */);
                } else if (buildState.imagesInTurnaround) {
                    _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0 /* holdTime */, coordInfo.coord);
...
void SprayStyleSpotItem::_appendLoadedMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
    qCDebug(SprayStyleSpotItemLog) << "_appendLoadedMissionItems";
...
void SprayStyleSpotItem::addKMLVisuals(KMLPlanDomDocument& domDocument)
{
...
void SprayStyleSpotItem::_recalcComplexDistance(void)
{
    _complexDistance = 0;
...
double SprayStyleSpotItem::amslEntryAlt(void) const
{
    double alt                  = qQNaN();
    double distanceToSurface    = _spotCalc  .distanceToSurface()->rawValue().toDouble();
    ...
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleSpotItemLog) << "Internal Error: amslEntryAlt incorrect _spotCalc    .distanceMode" << _spotCalc  .distanceMode();
        break;
    }
...
double SprayStyleSpotItem::amslExitAlt(void) const
{
    double alt                  = qQNaN();
    ...
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleSpotItemLog) << "Internal Error: amslExitAlt incorrect _spotCalc     .distanceMode" << _spotCalc  .distanceMode();
        break;
    }
...
void SprayStyleSpotItem::applyNewAltitude(double newAltitude)
{
    _spotCalc    .valueSetIsDistance()->setRawValue(true);
    _spotCalc    .distanceToSurface()->setRawValue(newAltitude);
}

double SprayStyleSpotItem::minAMSLAltitude(void) const
{
    ...
    if (_spotCalc    .distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain) {
        ...
        return _spotCalc     .distanceToSurface()->rawValue().toDouble() + (_spotCalc     .distanceMode() == QGroundControlQmlGlobal::AltitudeModeRelative ? _missionController->plannedHomePosition().altitude() : 0);
    }
}

double SprayStyleSpotItem::maxAMSLAltitude(void) const
{
    // FIXME: What about terrain frame
