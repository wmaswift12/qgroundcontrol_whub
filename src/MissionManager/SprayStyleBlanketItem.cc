...
#include "SprayStyleBlanketItem.h"
...
QGC_LOGGING_CATEGORY(SprayStyleBlanketItemLog, "SprayStyleBlanketItemLog")

SprayStyleBlanketItem::SprayStyleBlanketItem(PlanMasterController* masterController, bool flyView, QString settingsGroup)
    : ComplexMissionItem                (masterController, flyView)
    , _sprayCalc                        (masterController, settingsGroup)
    , _metaDataMap                      (FactMetaData::createMapFromJsonFile(QStringLiteral(":/json/SprayStyleBlanket.SettingsGroup.json"), this))
    ...
    , _gridAngleFact                    (settingsGroup, FactMetaData::createMapFromJsonFile(":/json/Blanket.SettingsGroup.json", this)["GridAngle"])
{
    ...
    connect(&_terrainPolyPathQueryTimer, &QTimer::timeout, this, &SprayStyleBlanketItem::_reallyQueryTransectsPathHeightInfo);

    // The follow is used to compress multiple recalc calls in a row to into a single call.
    connect(this, &SprayStyleBlanketItem::_updateFlightPathSegmentsSignal, this, &SprayStyleBlanketItem::_updateFlightPathSegmentsDontCallDirectly,   Qt::QueuedConnection);
    qgcApp()->addCompressedSignal(QMetaMethod::fromSignal(&SprayStyleBlanketItem::_updateFlightPathSegmentsSignal));

    connect(&_turnAroundDistanceFact,                   &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(&_hoverAndCaptureFact,                      &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(&_refly90DegreesFact,                       &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(&_terrainAdjustMaxClimbRateFact,            &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(&_terrainAdjustMaxDescentRateFact,          &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(&_terrainAdjustToleranceFact,               &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,        this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(&_cameraTriggerInTurnAroundFact,            &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(_sprayCalc.adjustedFootprintSide(),         &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(_sprayCalc.adjustedFootprintFrontal(),      &Fact::valueChanged,                this, &SprayStyleBlanketItem::_rebuildTransects);
    connect(_sprayCalc.distanceToSurface(),             &Fact::rawValueChanged,             this, &SprayStyleBlanketItem::_rebuildTransects);
 
    connect(&_sprayCalc,                                &SprayCalc::distanceModeChanged,   this, &SprayStyleBlanketItem::_rebuildTransects);

    connect(&_turnAroundDistanceFact,                   &Fact::valueChanged,            this, &SprayStyleBlanketItem::complexDistanceChanged);
    connect(&_hoverAndCaptureFact,                      &Fact::valueChanged,            this, &SprayStyleBlanketItem::complexDistanceChanged);
    connect(&_refly90DegreesFact,                       &Fact::valueChanged,            this, &SprayStyleBlanketItem::complexDistanceChanged);
    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,    this, &SprayStyleBlanketItem::complexDistanceChanged);

    connect(&_turnAroundDistanceFact,                   &Fact::valueChanged,            this, &SprayStyleBlanketItem::greatestDistanceToChanged);
    connect(&_hoverAndCaptureFact,                      &Fact::valueChanged,            this, &SprayStyleBlanketItem::greatestDistanceToChanged);
    connect(&_refly90DegreesFact,                       &Fact::valueChanged,            this, &SprayStyleBlanketItem::greatestDistanceToChanged);
    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,    this, &SprayStyleBlanketItem::greatestDistanceToChanged);

    connect(&_turnAroundDistanceFact,                   &Fact::valueChanged,            this, &SprayStyleBlanketItem::_setDirty);
    connect(&_cameraTriggerInTurnAroundFact,            &Fact::valueChanged,            this, &SprayStyleBlanketItem::_setDirty);
    connect(&_hoverAndCaptureFact,                      &Fact::valueChanged,            this, &SprayStyleBlanketItem::_setDirty);
    connect(&_refly90DegreesFact,                       &Fact::valueChanged,            this, &SprayStyleBlanketItem::_setDirty);
    connect(&_terrainAdjustMaxClimbRateFact,            &Fact::valueChanged,            this, &SprayStyleBlanketItem::_setDirty);
    connect(&_terrainAdjustMaxDescentRateFact,          &Fact::valueChanged,            this, &SprayStyleBlanketItem::_setDirty);
    connect(&_terrainAdjustToleranceFact,               &Fact::valueChanged,            this, &SprayStyleBlanketItem::_setDirty);
    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,    this, &SprayStyleBlanketItem::_setDirty);

    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::dirtyChanged,   this, &SprayStyleBlanketItem::_setIfDirty);
    connect(&_sprayCalc,                               &SprayCalc::dirtyChanged,      this, &SprayStyleBlanketItem::_setIfDirty);

    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::pathChanged,    this, &SprayStyleBlanketItem::coveredAreaChanged);

    connect(_sprayCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleBlanketItem::_amslEntryAltChanged);
    connect(_sprayCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleBlanketItem::_amslExitAltChanged);
    connect(_sprayCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleBlanketItem::minAMSLAltitudeChanged);
    connect(_sprayCalc.distanceToSurface(),            &Fact::rawValueChanged,             this, &SprayStyleBlanketItem::maxAMSLAltitudeChanged);
    connect(&_sprayCalc,                               &SprayCalc::distanceModeChanged,   this, &SprayStyleBlanketItem::_amslEntryAltChanged);
    connect(&_sprayCalc,                               &SprayCalc::distanceModeChanged,   this, &SprayStyleBlanketItem::_amslExitAltChanged);
    connect(&_sprayCalc,                               &SprayCalc::distanceModeChanged,   this, &SprayStyleBlanketItem::minAMSLAltitudeChanged);
    connect(&_sprayCalc,                               &SprayCalc::distanceModeChanged,   this, &SprayStyleBlanketItem::maxAMSLAltitudeChanged);
    connect(&_sprayCalc,                               &SprayCalc::distanceModeChanged,   this, &SprayStyleBlanketItem::_updateFlightPathSegmentsSignal);
    connect(&_sprayCalc,                               &SprayCalc::distanceModeChanged,   this, &SprayStyleBlanketItem::_distanceModeChanged);
    connect(&_sprayCalc,                               &SprayCalc::distanceModeChanged,  _missionController, &MissionController::recalcTerrainProfile);

    connect(&_hoverAndCaptureFact,                      &Fact::rawValueChanged,         this, &SprayStyleBlanketItem::_handleHoverAndCaptureEnabled);

    connect(this,                                       &SprayStyleBlanketItem::visualTransectPointsChanged, this, &SprayStyleBlanketItem::complexDistanceChanged);
    connect(this,                                       &SprayStyleBlanketItem::visualTransectPointsChanged, this, &SprayStyleBlanketItem::greatestDistanceToChanged);
    connect(this,                                       &SprayStyleBlanketItem::wizardModeChanged,           this, &SprayStyleBlanketItem::readyForSaveStateChanged);


    connect(&_surveyAreaPolygon,                        &QGCMapPolygon::isValidChanged, this, &SprayStyleBlanketItem::readyForSaveStateChanged);

    setDirty(false);
}

void SprayStyleBlanketItem::_setCameraShots(int cameraShots)
{
    if (_cameraShots != cameraShots) {
        _cameraShots = cameraShots;
        emit cameraShotsChanged();
    }
    qCDebug(SprayStyleBlanketItemLog) << "_______________________Recalculating Camera Shots:" << _cameraShots;
}

void SprayStyleBlanketItem::setDirty(bool dirty)
{
    if (!dirty) {
        _surveyAreaPolygon.setDirty(false);
        _sprayCalc.setDirty(false);
    }
    if (_dirty != dirty) {
        _dirty = dirty;
...
void SprayStyleBlanketItem::_save(QJsonObject& complexObject)
{
    ...
    if (_sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain) {
    ...
    QJsonObject SprayCalcObject;
    _sprayCalc.save(SprayCalcObject);
    innerObject[_jsonSprayCalcKey] = SprayCalcObject;
    ...
    //innerObject[""] = _sprayCalc.()->rawValue().toDouble();
    
    complexObject[_jsonSprayStyleBlanketItemKey] = innerObject;
}

void SprayStyleBlanketItem::setSequenceNumber(int sequenceNumber)
{
...
bool SprayStyleBlanketItem::_load(const QJsonObject& complexObject, bool forPresets, QString& errorString)
{
    QList<JsonHelper::KeyValidateInfo> keyInfoList = {
        { _jsonSprayStyleBlanketItemKey, QJsonValue::Object, true },
    };
    if (!JsonHelper::validateKeys(complexObject, keyInfoList, errorString)) {
        return false;
    }

    // The SprayStyleBlanketItem is a sub-object of the main complex item object
    QJsonObject innerObject = complexObject[_jsonSprayStyleBlanketItemKey].toObject();
    ...
    if (version == 1) {
        ...
        //  - _jsonTerrainFollowKeyDeprecated replaced by SprayCalc::distanceMode
    ...
    if (version != 2) {
        errorString = tr("SprayStyleBlanketItem version %2 not supported").arg(version);
        return false;
    }
    ...
    QList<JsonHelper::KeyValidateInfo> innerKeyInfoList = {
        ...
        { _jsonSprayCalcKey,               QJsonValue::Object, true },
    ...
    if (!forPresets) {
        ...
        qCDebug(SprayStyleBlanketItemLog) << "Loading Mission Items all";
    }

    // Load SprayCalc data
    if (!_sprayCalc.load(innerObject[_jsonSprayCalcKey].toObject(), v1FollowTerrain, errorString, forPresets)) {
        return false;
    }

    // Load SprayStyleBlanketItem individual values
    ...
    /*if (innerObject.contains("")) {
        _sprayCalc.()->setRawValue(innerObject[""].toDouble());
    } else {
        qCDebug(SprayStyleBlanketItemLog) << " key missing from plan file. Using default.";
        _sprayCalc.()->setRawValue(0.0); // Or your preferred default
    }*/    
    ...
    if (_sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain) {
        ...
        if (!forPresets) {
            ...
            qCDebug(SprayStyleBlanketItemLog) << "Loading Mission Items, params7 min max ALT";
        }
    }

    if (!forPresets) {
        if (_sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeTerrainFrame) {
            ...
            qCDebug(SprayStyleBlanketItemLog) << "emit Altitude HEIGHTS";
        } else {
            ...
            qCDebug(SprayStyleBlanketItemLog) << "emit Altitude change MIN MAX";
        }
    }
...
double SprayStyleBlanketItem::greatestDistanceTo(const QGeoCoordinate &other) const
{
...
void SprayStyleBlanketItem::setMissionFlightStatus(MissionController::MissionFlightStatus_t& missionFlightStatus)
{
...
void SprayStyleBlanketItem::_setDirty(void)
{
    setDirty(true);
}

void SprayStyleBlanketItem::_setIfDirty(bool dirty)
{
    if (dirty) {
        setDirty(true);
    }
...
void SprayStyleBlanketItem::_updateCoordinateAltitudes(void)
{
    emit coordinateChanged(coordinate());
    emit exitCoordinateChanged(exitCoordinate());
}

double SprayStyleBlanketItem::coveredArea(void) const
{
    return _surveyAreaPolygon.area();
}

bool SprayStyleBlanketItem::_hasTurnaround(void) const
{
    return _turnAroundDistance() > 0;
}

double SprayStyleBlanketItem::_turnAroundDistance(void) const
{
    return _turnAroundDistanceFact.rawValue().toDouble();
}

bool SprayStyleBlanketItem::hoverAndCaptureAllowed(void) const
{
    return _controllerVehicle->multiRotor() || _controllerVehicle->vtol();
}

void SprayStyleBlanketItem::_rebuildTransects(void)
{
    if (_ignoreRecalc) {
        return;
    }
    ...
    switch (_sprayCalc.distanceMode()) {
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleBlanketItemLog) << "Internal Error: _rebuildTransects - invalid _sprayCalc.distanceMode()" << _sprayCalc.distanceMode();
        return;
    ...
    qCDebug(SprayStyleBlanketItemLog) << "______________________________Go To Function _recalcComplexDistance()";
    _recalcCameraShots();
...
void SprayStyleBlanketItem::_segmentTerrainCollisionChanged(bool terrainCollision)
{
...
void SprayStyleBlanketItem::_updateFlightPathSegmentsDontCallDirectly(void)
{
    ...
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleBlanketItemLog) << "Internal Error: _updateFlightPathSegmentsDontCallDirectly - invalid _sprayCalc.distanceMode()" << _sprayCalc.distanceMode();
        return;
    case QGroundControlQmlGlobal::AltitudeModeRelative:
    case QGroundControlQmlGlobal::AltitudeModeAbsolute:
    {
    ...
    case QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain:
    case QGroundControlQmlGlobal::AltitudeModeTerrainFrame:
        if (_sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain && _loadedMissionItems.count()) {
            ...
            for (const MissionItem* missionItem: _loadedMissionItems) {
                if (missionItem->command() == MAV_CMD_NAV_WAYPOINT || missionItem->command() == MAV_CMD_CONDITION_GATE) {
                    ...
                    qCDebug(SprayStyleBlanketItemLog) << "GeoCoordniate include param7 Altitude";
                }
            }
        } else {
            // We are either:
            ...
            if (_rgFlightPathCoordInfo.count()) {
                FlightPathSegment::SegmentType segmentType = _sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain ? FlightPathSegment::SegmentTypeGeneric : FlightPathSegment::SegmentTypeTerrainFrame;
...
void SprayStyleBlanketItem::_queryTransectsPathHeightInfo(void)
{
    _rgPathHeightInfo.clear();
...
void SprayStyleBlanketItem::_reallyQueryTransectsPathHeightInfo(void)
{
    qCDebug(SprayStyleBlanketItemLog) << "_reallyQueryTransectsPathHeightInfo";
    ...
    if (transectPoints.count() > 1) {
        ...
        connect(_currentTerrainPolyPathQuery, &TerrainPolyPathQuery::terrainDataReceived, this, &SprayStyleBlanketItem::_polyPathTerrainData);
        _currentTerrainPolyPathQuery->requestData(transectPoints);
    }
}

void SprayStyleBlanketItem::_queryMissionItemCoordHeights(void)
{
    qCDebug(SprayStyleBlanketItemLog) << "_queryMissionItemCoordHeights";

    _rgFlyThroughMissionItemCoords.clear();

    if (_currentTerrainAtCoordinateQuery) {
        qCWarning(SprayStyleBlanketItemLog) << "Internal error: _queryMissionItemCoordHeights called multiple times";
    ...
    if (_rgFlyThroughMissionItemCoords.count()) {
        ...
        connect(_currentTerrainAtCoordinateQuery, &TerrainAtCoordinateQuery::terrainDataReceived, this, &SprayStyleBlanketItem::_missionItemCoordTerrainData);
        _currentTerrainAtCoordinateQuery->requestData(_rgFlyThroughMissionItemCoords);
    }
}

void SprayStyleBlanketItem::_polyPathTerrainData(bool success, const QList<TerrainPathQuery::PathHeightInfo_t>& rgPathHeightInfo)
{
    qCDebug(SprayStyleBlanketItemLog) << "_polyPathTerrainData" << success;
...
void SprayStyleBlanketItem::_missionItemCoordTerrainData(bool success, QList<double> heights)
{
    qCDebug(SprayStyleBlanketItemLog) << "_polyPathTerrainData" << success;
...
SprayStyleBlanketItem::ReadyForSaveState SprayStyleBlanketItem::readyForSaveState(void) const
{
...
void SprayStyleBlanketItem::_adjustForAvailableTerrainData(void)
{
    switch (_sprayCalc.distanceMode()) {
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleBlanketItemLog) << "Internal Error: _adjustForAvailableTerrainData - invalid _sprayCalc.distanceMode()" << _sprayCalc.distanceMode();
        return;
    case QGroundControlQmlGlobal::AltitudeModeRelative:
    case QGroundControlQmlGlobal::AltitudeModeAbsolute:
    ...
    emit minAMSLAltitudeChanged();
    emit maxAMSLAltitudeChanged();
    qCDebug(SprayStyleBlanketItemLog) << "Emits signal Altitude change in TERRAIN";
}
...
double SprayStyleBlanketItem::_altitudeBetweenCoords(const QGeoCoordinate& fromCoord, const QGeoCoordinate& toCoord, double percentTowardsTo)
{
...
int SprayStyleBlanketItem::_maxPathHeight(const TerrainPathQuery::PathHeightInfo_t& pathHeightInfo, int fromIndex, int toIndex, double& maxHeight)
{
    maxHeight = qQNaN();
...
void SprayStyleBlanketItem::_adjustForMaxRates(void)
{
    ...
    if (qIsNaN(flightSpeed) || (maxClimbRate == 0 && maxDescentRate == 0)) {
        if (qIsNaN(flightSpeed)) {
            qWarning() << "SprayStyleBlanketItem::_adjustForMaxRates called with flightSpeed = NaN";
        }
        return;
    }
...
void SprayStyleBlanketItem::_adjustForTolerance(void)
{
...
void SprayStyleBlanketItem::_buildFlightPathCoordInfoFromTransects(void)
{
    _minAMSLAltitude = _maxAMSLAltitude = qQNaN();

    double distanceToSurface = _sprayCalc.distanceToSurface()->rawValue().toDouble();
...
void SprayStyleBlanketItem::_buildFlightPathCoordInfoFromPathHeightInfoForCalcAboveTerrain(void)
{
    _minAMSLAltitude = _maxAMSLAltitude = qQNaN();

    if (_rgPathHeightInfo.count() == 0) {
        qCWarning(SprayStyleBlanketItemLog) << "SprayStyleBlanketItem::_buildFlightPathCoordInfoFromPathHeightInfo terrain height needed but _rgPathHeightInfo.count() == 0";
        return;
    }
...
void SprayStyleBlanketItem::_buildFlightPathCoordInfoFromPathHeightInfoForTerrainFrame(void)
{
    _minAMSLAltitude = _maxAMSLAltitude = qQNaN();

    if (_rgPathHeightInfo.count() == 0) {
        qCWarning(SprayStyleBlanketItemLog) << "SprayStyleBlanketItem::_buildFlightPathCoordInfoFromPathHeightInfoForTerrainFrame terrain height needed but _rgPathHeightInfo.count() == 0";
        return;
    }
...
void SprayStyleBlanketItem::_buildFlightPathCoordInfoFromMissionItems(void)
{
    _minAMSLAltitude = _maxAMSLAltitude = qQNaN();

    if (_rgFlyThroughMissionItemCoordsTerrainHeights.count() == 0) {
        qCWarning(SprayStyleBlanketItemLog) << "_buildFlightPathCoordInfoFromMissionItems - terrain height needed but _rgFlyThroughMissionItemCoordsTerrainHeights.count() == 0";
        return;
    }
    if (_rgFlyThroughMissionItemCoordsTerrainHeights.count() != _rgFlyThroughMissionItemCoords.count()) {
        qCWarning(SprayStyleBlanketItemLog) << "_buildFlightPathCoordInfoFromMissionItems - _rgFlyThroughMissionItemCoordsTerrainHeights.count() != _rgFlyThroughMissionItemCoords.count()";
        return;
    }
    if (_rgFlyThroughMissionItemCoords.count() < 2) {
        qCWarning(SprayStyleBlanketItemLog) << "_buildFlightPathCoordInfoFromMissionItems - rgFlyThroughMissionItemCoords.count() < 2";
        return;
    }
...
int SprayStyleBlanketItem::lastSequenceNumber(void) const
{
    if (_loadedMissionItems.count()) {
...
void SprayStyleBlanketItem::_distanceModeChanged(int distanceMode)
{
...
void SprayStyleBlanketItem::_handleHoverAndCaptureEnabled(QVariant enabled)
{
...
void SprayStyleBlanketItem::appendMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
    if (_loadedMissionItems.count()) {
...
void SprayStyleBlanketItem::_appendWaypoint(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, MAV_FRAME mavFrame, float holdTime, const QGeoCoordinate& coordinate)
{
    qCDebug(SprayStyleBlanketItemLog) << "Loading Mission Items and Altitude at WAYPOINTS";
    double altitude = _sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain ? coordinate.altitude() : _sprayCalc.distanceToSurface()->rawValue().toDouble();
...
void SprayStyleBlanketItem::_appendSprayAreaON(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, float triggerDistance)
{
    float vol      = triggerDistance;
    //double angle    = gridAngleFact()->rawValue().toDouble();
    //double rad      = (M_PI / 180.0) * angle;
    //float  cosAb    = abs(cos(rad));
    
    float spacing  = _sprayCalc.adjustedFootprintSide()->rawValue().toDouble();
    float area     = _surveyAreaPolygon.area();

    //float var           = 0.12;
    //float literMeter   = (vol/(area))*spacing;
    float literMeter2     = vol/(_totalLineDistance);
    //float result        = literMeter-(literMeter*(var)*cosAb);
    float scriptTimeout = 0.0f;
...
void SprayStyleBlanketItem::_appendSprayAreaOFF(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, float triggerDistance)
{
    float  vol      = triggerDistance;
    //double angle    = gridAngleFact()->rawValue().toDouble();
    //double rad      = (M_PI / 180.0) * angle;
...
void SprayStyleBlanketItem::_appendConditionGate(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, MAV_FRAME mavFrame, const QGeoCoordinate& coordinate)
{
    double altitude = _sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain ? coordinate.altitude() : _sprayCalc.distanceToSurface()->rawValue().toDouble();
...
//ADDITIONAL for DO_SET_RESUME for OFF
void SprayStyleBlanketItem::_appendResumeOFF(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, MAV_FRAME mavFrame, float holdTime, const QGeoCoordinate& coordinate)
{
    qCDebug(SprayStyleBlanketItemLog) << "Loading Mission Items and Altitude at DO_RESUME_OFF";
    double altitude = _sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain ? coordinate.altitude() : _sprayCalc.distanceToSurface()->rawValue().toDouble();
...
//ADDITIONAL for DO_SET_RESUME for ON
void SprayStyleBlanketItem::_appendResumeON(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, MAV_FRAME mavFrame, float holdTime, const QGeoCoordinate& coordinate)
{
    qCDebug(SprayStyleBlanketItemLog) << "Loading Mission Items and Altitude at DO_RESUME_ON";
    double altitude = _sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain ? coordinate.altitude() : _sprayCalc.distanceToSurface()->rawValue().toDouble();
...
//ADDITIONAL for SPRAY ON
void SprayStyleBlanketItem::_appendScriptSprayON(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, float triggerDistance, int off)
{
    float vol      = triggerDistance;
    //double angle    = gridAngleFact()->rawValue().toDouble();
    //double rad      = (M_PI / 180.0) * angle;
    ...
    float spacing  = _sprayCalc.adjustedFootprintSide()->rawValue().toDouble();
    float area     = _surveyAreaPolygon.area();
    float  hectar   = (area)/10000;
    //float  hectarRound = std::floor(hectar*100) / 100;
    
    //float  adjustVol = vol*hectarRound;
    float adjustVol = vol*hectar; 

    //float var           = 0.12;
    //float literMeter    = (adjustVol/(area))*spacing;
    float literMeter2     = adjustVol/(_totalLineDistance);
    //float result        = literMeter-(literMeter*(var)*(cosAb));
    //double result2      = (vol/10000)*(spacing);
    float scriptTimeout = 0.0f;
    
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ angle: " << angle;
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ volume: " << vol;
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ radians: " << rad;
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ area m^2: " << area;
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ hectar: " << hectar;
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ Adjust Volume: " << adjustVol;
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ literMeter: " << literMeter;    
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ cos: " << cos(rad);    
    //qCDebug(SprayStyleBlanketItemLog) << "_________________________________READ After cos: " << literMeter*(0.1)*cos(rad);
...
//ADDITIONAL for SPRAY OFF
void SprayStyleBlanketItem::_appendScriptSprayOFF(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, float triggerDistance, int off)
{
    float vol      = triggerDistance;
    //double angle    = gridAngleFact()->rawValue().toDouble();
    //double rad      = (M_PI / 180.0) * angle;
...
// END Modify
void SprayStyleBlanketItem::_appendCameraTriggerDistanceUpdatePoint(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, MAV_FRAME mavFrame, const QGeoCoordinate& coordinate, bool useConditionGate, float triggerDistance, int off)
{ //For Liter per AREA / HECTAR
    if (useConditionGate) {
    ...
    _appendScriptSprayON(items, missionItemParent, seqNum, triggerDistance, off);
    _appendResumeON(items, missionItemParent, seqNum, mavFrame, 0, coordinate);
    //_appendScriptSprayON(items, missionItemParent, seqNum, triggerDistance, off);
}

SprayStyleBlanketItem::BuildMissionItemsState_t SprayStyleBlanketItem::_buildMissionItemsState(void) const
{
...
void SprayStyleBlanketItem::_buildAndAppendMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
    //float                       off         = 0;
    ...
    qCDebug(SprayStyleBlanketItemLog) << "_buildAndAppendMissionItems";
    ...
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleBlanketItemLog) << "Internal Error: _buildAndAppendMissionItems incorrect _sprayCalc.distanceMode" << _sprayCalc.distanceMode();
        mavFrame = MAV_FRAME_GLOBAL_RELATIVE_ALT;
        break;
    }
    ...
    for (int coordIndex=0; coordIndex<_rgFlightPathCoordInfo.count(); coordIndex++) {
        ...
        case CoordTypeTurnaround:
        {
            ...
            bool lastExitTurnaround     = coordIndex == _rgFlightPathCoordInfo.count() - 1;
            if (buildState.addTriggerAtFirstAndLastPoint && (firstEntryTurnaround || lastExitTurnaround)) {
                _appendCameraTriggerDistanceUpdatePoint(items, missionItemParent, seqNum, mavFrame, coordInfo.coord, buildState.useConditionGate, firstEntryTurnaround ? triggerDistance() : 0, 0);
            } else {
                _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0 /* holdTime */, coordInfo.coord);
            }
        }
            break;
        case CoordTypeInteriorHoverTrigger:
            qCWarning(SprayStyleBlanketItemLog) << "___________________________________Un-Important section for build Waypoint and SprayOFF";
            //_appendWaypoint(items, missionItemParent, seqNum, mavFrame, 9999, coordInfo.coord); //NO NEED
            //_appendSprayAreaON(items, missionItemParent, seqNum, 9999);//NO NEED
            break;
        case CoordTypeSurveyEntry:
            if (triggerCamera()) {
                if (hoverAndCaptureEnabled()) { //For Liter All AREA
                    _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0, coordInfo.coord);
                    _appendSprayAreaON(items, missionItemParent, seqNum, triggerDistance()); //SprayON
                    _appendResumeON(items, missionItemParent, seqNum, mavFrame, 0, coordInfo.coord);
                    //_appendSprayAreaON(items, missionItemParent, seqNum, triggerDistance()); //SprayON
                } else {
                    ...
                    _appendCameraTriggerDistanceUpdatePoint(items, missionItemParent, seqNum, mavFrame, coordInfo.coord, buildState.useConditionGate, triggerDistance(), 1);
                }
            } else {
                _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0 /* holdTime */, coordInfo.coord);
            }
        ...
        case CoordTypeSurveyExit:
            ...
            if (triggerCamera()) {
                if (hoverAndCaptureEnabled()) { //For Liter All AREA
                    _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0, coordInfo.coord);
                    _appendSprayAreaOFF(items, missionItemParent, seqNum, triggerDistance()); //SprayOFF
                    _appendResumeOFF(items, missionItemParent, seqNum, mavFrame, 0, coordInfo.coord);
                    //_appendSprayAreaOFF(items, missionItemParent, seqNum, triggerDistance()); //SprayOFF
                    //_appendSprayAreaON(items, missionItemParent, seqNum);
                } else if (buildState.addTriggerAtFirstAndLastPoint && !buildState.hasTurnarounds && lastSurveyExit) {
                    // For Liter per AREA / HECTAR
                    //_appendCameraTriggerDistanceUpdatePoint(items, missionItemParent, seqNum, mavFrame, coordInfo.coord, buildState.useConditionGate, 0 /* triggerDistance */,0 );
                    _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0 /* holdTime */, coordInfo.coord);
                    _appendScriptSprayOFF(items, missionItemParent, seqNum, triggerDistance(), 0);
                    _appendResumeOFF(items, missionItemParent, seqNum, mavFrame, 0, coordInfo.coord);
                    //_appendScriptSprayOFF(items, missionItemParent, seqNum, triggerDistance(), 0);
                } else if (buildState.imagesInTurnaround) {
                    // For Liter per AREA / HECTAR
                    ...
                    _appendCameraTriggerDistanceUpdatePoint(items, missionItemParent, seqNum, mavFrame, coordInfo.coord, buildState.useConditionGate, 0 /* triggerDistance */, 1);
                }
            } else {
                _appendWaypoint(items, missionItemParent, seqNum, mavFrame, 0 /* holdTime */, coordInfo.coord);
            }
...
void SprayStyleBlanketItem::_appendLoadedMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
    qCDebug(SprayStyleBlanketItemLog) << "_appendLoadedMissionItems";
...
void SprayStyleBlanketItem::addKMLVisuals(KMLPlanDomDocument& domDocument)
{
...
void SprayStyleBlanketItem::_recalcComplexDistance(void)
{
    int num = 0;
    double distanceWaypoint = 0;
    double totalOffDistance = 0;
    _totalLineDistance = 0;
    _complexDistance = 0;

    //MODIFY to calculate the each line Distance
    for (int coordIndex=0; coordIndex<_rgFlightPathCoordInfo.count(); coordIndex++) {
        const CoordInfo_t& coordInfo = _rgFlightPathCoordInfo[coordIndex];
        switch (coordInfo.coordType) {
            case CoordTypeSurveyExit:
            bool lastSurveyExit = coordIndex == _rgFlightPathCoordInfo.count() - 1;
            //MODIFY to Calculate the distance of each turnaround
                if (!lastSurveyExit) {
                    const QGeoCoordinate coord1 = coordInfo.coord;
                    const QGeoCoordinate coord2 = _rgFlightPathCoordInfo[coordIndex + 1].coord;
                    double turnDistance = coord1.distanceTo(coord2);
                    totalOffDistance += turnDistance;
                    num += 1;
                    qCDebug(SprayStyleBlanketItemLog) << "________________________No. Turns:" << num;
                    qCDebug(SprayStyleBlanketItemLog) << "________________________Turnaround distance:" << turnDistance;
                    qCDebug(SprayStyleBlanketItemLog) << "________________________Total turn Distance:" << totalOffDistance;
                } else {
                    qCDebug(SprayStyleBlanketItemLog) << "Last CoordTypeSurveyExit — no next point to compute distance. FINAL TOTAL TURN DISTANCE: "<< totalOffDistance;
                }
        }
    }
    qCDebug(SprayStyleBlanketItemLog) << "* * * * * * * * * * * * * * * *FINAL TOTAL TURN DISTANCE: "<< totalOffDistance;
    //END Modify
    ...
    for (int i=0; i<_visualTransectPoints.count() - 1; i++) {
        ...
        qCDebug(SprayStyleBlanketItemLog) << "______________________________Waypoint: to next point:" << i << i+1;
        qCDebug(SprayStyleBlanketItemLog) << "______________________________Distance between:" << distanceWaypoint;
        qCDebug(SprayStyleBlanketItemLog) << "______________________________RESULT, complexDistance:" << _complexDistance;
        qCDebug(SprayStyleBlanketItemLog) << "____________________________________________________________________________";
    }
    emit complexDistanceChanged();
    qCDebug(SprayStyleBlanketItemLog) << "______________________________RESULT, complexDistance:" << _complexDistance;
    
    _totalLineDistance = _complexDistance - totalOffDistance;
    qCDebug(SprayStyleBlanketItemLog) << "______________________________TOTAL LINES, totalLineDistance:" << _totalLineDistance;
    emit totalLineDistanceChanged();
}

double SprayStyleBlanketItem::amslEntryAlt(void) const
{
    double alt                  = qQNaN();
    double distanceToSurface    = _sprayCalc.distanceToSurface()->rawValue().toDouble();
    ...
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleBlanketItemLog) << "Internal Error: amslEntryAlt incorrect _sprayCalc.distanceMode" << _sprayCalc.distanceMode();
        break;
    }
...
double SprayStyleBlanketItem::amslExitAlt(void) const
{
    double alt                  = qQNaN();
    ...
    case QGroundControlQmlGlobal::AltitudeModeMixed:
    case QGroundControlQmlGlobal::AltitudeModeNone:
        qCWarning(SprayStyleBlanketItemLog) << "Internal Error: amslExitAlt incorrect _sprayCalc.distanceMode" << _sprayCalc.distanceMode();
        break;
    }
...
void SprayStyleBlanketItem::applyNewAltitude(double newAltitude)
{
    _sprayCalc.valueSetIsDistance()->setRawValue(true);
    _sprayCalc.distanceToSurface()->setRawValue(newAltitude);
}

double SprayStyleBlanketItem::minAMSLAltitude(void) const
{
    ...
    if (_sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeCalcAboveTerrain) {
        ...
        return _sprayCalc.distanceToSurface()->rawValue().toDouble() + (_sprayCalc.distanceMode() == QGroundControlQmlGlobal::AltitudeModeRelative ? _missionController->plannedHomePosition().altitude() : 0);
    }
}

double SprayStyleBlanketItem::maxAMSLAltitude(void) const
{
    // FIXME: What about terrain frame
