 ...
 ****************************************************************************/
 ...
 bool SurveyComplexItem::load(const QJsonObject& complexObject, int sequenceNumber, QString& errorString)
 {
     ...
     if (version == 4 || version == 5) {
        qCDebug(SurveyComplexItemLog) << "Version 4 or 5, go to loadV4V5 TransectComplex"; 
         ...
         if (version == 2) {
            qCDebug(SurveyComplexItemLog) << "Version 2, changing to ver. 3"; 
            // Convert to v3
         ...
         if (!_loadV3(complexObject, sequenceNumber, errorString)) {
             qCDebug(SurveyComplexItemLog) << "Going to loadV3";
             return false;
         }
 ...
 bool SurveyComplexItem::_loadV4V5(const QJsonObject& complexObject, int sequenceNumber, QString& errorString, int version, bool forPresets)
 {
     ...
     qCDebug(SurveyComplexItemLog) << "Load the TransectStyleComplexItem file to be continued";
     ...
     _ignoreRecalc = false;
     qCDebug(SurveyComplexItemLog) << "Loading Survey items finished";
     return true;
 }
 ...
 bool SurveyComplexItem::_loadV3(const QJsonObject& complexObject, int sequenceNumber, QString& errorString)
 {
     ...
     qCDebug(SurveyComplexItemLog) << "loadV3, loading the complex items manually";
