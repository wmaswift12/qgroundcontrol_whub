...
Q_DECLARE_LOGGING_CATEGORY(SpotComplexItemLog)

class SpotComplexItem : public SprayStyleSpotItem
{
    Q_OBJECT
...
public:
    ...
    SpotComplexItem(PlanMasterController* masterController, bool flyView, const QString& kmlFile);
    ...
    Fact*           corridorWidth   (void) { _corridorWidthFact.setRawValue(0);; return &_corridorWidthFact; }
    QGCMapPolyline* corridorPolyline(void) { return &_corridorPolyline; }

    Q_INVOKABLE void rotateEntryPoint(void);

    // Overrides from SprayStyleSpotItem
    ...
    QString             commandDescription  (void) const final { return tr("Spot"); }
    QString             commandName         (void) const final { return tr("Spot"); }
    ...
    static constexpr const char* jsonSpotComplexItemTypeValue = "Spot";
