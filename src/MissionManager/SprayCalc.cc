...
SprayCalc::SprayCalc(PlanMasterController* masterController, const QString& settingsGroup, QObject* parent)
    ...
    , _metaDataMap                  (FactMetaData::createMapFromJsonFile(QStringLiteral(":/json/SprayCalc.FactMetaData.json"), this))
    ...
    , _adjustedFootprintFrontalFact (settingsGroup, _metaDataMap[adjustedFootprintFrontalName])
{
    ...
    connect(&_valueSetIsDistanceFact,       &Fact::valueChanged,                this, &SprayCalc::_setDirty);
    connect(&_distanceToSurfaceFact,        &Fact::valueChanged,                this, &SprayCalc::_setDirty);
    connect(&_imageDensityFact,             &Fact::valueChanged,                this, &SprayCalc::_setDirty);
    connect(&_frontalOverlapFact,           &Fact::valueChanged,                this, &SprayCalc::_setDirty);
    connect(&_sideOverlapFact,              &Fact::valueChanged,                this, &SprayCalc::_setDirty);
    connect(&_adjustedFootprintSideFact,    &Fact::valueChanged,                this, &SprayCalc::_setDirty);
    connect(&_adjustedFootprintFrontalFact, &Fact::valueChanged,                this, &SprayCalc::_setDirty);
    connect(&_cameraNameFact,               &Fact::valueChanged,                this, &SprayCalc::_setDirty);
    connect(this,                           &SprayCalc::distanceModeChanged,   this, &SprayCalc::_setDirty);

    connect(&_cameraNameFact, &Fact::valueChanged, this, &SprayCalc::_cameraNameChanged);
    connect(&_cameraNameFact, &Fact::valueChanged, this, &SprayCalc::isManualCameraChanged);
    connect(&_cameraNameFact, &Fact::valueChanged, this, &SprayCalc::isCustomCameraChanged);

    connect(&_distanceToSurfaceFact,    &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(&_imageDensityFact,         &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(&_frontalOverlapFact,       &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(&_sideOverlapFact,          &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(sensorWidth(),              &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(sensorHeight(),             &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(imageWidth(),               &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(imageHeight(),              &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(focalLength(),              &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
    connect(landscape(),                &Fact::rawValueChanged, this, &SprayCalc::_recalcTriggerDistance);
...
void SprayCalc::_cameraNameChanged(void)
{
    if (_disableRecalc) {
        return;
    }
...
void SprayCalc::_recalcTriggerDistance(void)
{
...
void SprayCalc::save(QJsonObject& json) const
{
...
bool SprayCalc::load(const QJsonObject& originalJson, bool deprecatedFollowTerrain, QString& errorString, bool forPresets)
{
    ...
    if (version != 2) {
        errorString = tr("SprayCalc section version %1 not supported").arg(version);
        return false;
    }
...
QString SprayCalc::canonicalCustomCameraName(void)
{
    // This string should NOT be translated
    return "Custom Camera";
}

QString SprayCalc::canonicalManualCameraName(void)
{
    // This string should NOT be translated
    return "Manual (no camera specs)";
}

QString SprayCalc::xlatCustomCameraName(void)
{
    return tr("Custom Camera");
}

QString SprayCalc::xlatManualCameraName(void)
{
    return tr("Manual (no camera specs)");
}

void SprayCalc::setDistanceMode(QGroundControlQmlGlobal::AltMode altMode)
{
...
void SprayCalc::_setDirty(void)
{
    setDirty(true);
}

void SprayCalc::setCameraBrand(const QString& cameraBrand)
{
...
void SprayCalc::setCameraModel(const QString& cameraModel)
{
...
void SprayCalc::_setBrandModelFromCanonicalName(const QString& cameraName)
{
...
void SprayCalc::_rebuildCameraModelList(void)
{
    _cameraModelList.clear();
...
void SprayCalc::_setCameraNameFromV3TransectLoad(const QString& cameraName)
{
...
QString SprayCalc::_validCanonicalCameraName(const QString& cameraName)
{
