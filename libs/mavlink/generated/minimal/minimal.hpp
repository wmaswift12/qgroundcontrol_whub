...
enum class MAV_TYPE : uint8_t
{
    ...
    SATELLITE=45, /* Satellite. Used for satellite-like systems (orbiting satellites, space stations). For rockets (or landers) use MAV_TYPE_ROCKET. | */
};

//! MAV_TYPE ENUM_END
constexpr auto MAV_TYPE_ENUM_END = 46;
